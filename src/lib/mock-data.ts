// Temporary mock data used while routes are migrated to React Query hooks.
// Replace each MOCK_* import in a route with the corresponding hook from src/hooks/,
// then delete this file once all routes are migrated.
...
export const MOCK_POST_DETAIL = {
  ...
  category: "Tips & Tactics",
  tags: ["maintenance", "hop-up", "beginner"],
  author: { ...MOCK_USERS.sniprcebu, joinedAt: "Jan 2023" },
  upvotes: 134,
  commentCount: 67,
  viewCount: 1204,
  createdAt: "1 day ago",
...
export const MOCK_EVENT_DETAIL = {
  ...MOCK_EVENTS[0],
  description:
    "Full night milsim operation. Bring your NV-compatible loadout, IR lasers, and suppressors if you have them. This is a structured game with mission objectives — not a skirmish. Briefing starts at 5:30 PM sharp. Do not be late.",
  rules:
...
export const MOCK_GROUPS = [
  ...
  },
  {
    ...
    description:
      "Dedicated to long-range precision shooting and patience. Bolt actions only.",
    memberCount: 18,
    gameCount: 15,
  },
  {
    ...
    description:
      "CQB and speedsoft players. Fast, aggressive, and always in the thick of it.",
    memberCount: 31,
    gameCount: 22,
  },
  {
  ...
  },
  {
    ...
    description:
      "The biggest airsoft community in Mactan Island. Open to all skill levels.",
    memberCount: 87,
    gameCount: 45,
  },
  {
    ...
    slug: "mandaue-milsim",
    description:
      "Tactical players from Mandaue. Reg games every other weekend.",
    memberCount: 29,
    gameCount: 19,
  },
];
