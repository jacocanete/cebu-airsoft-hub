...
import { MOCK_EVENT_DETAIL } from "@/lib/mock-data";
      ...
      <div className="flex flex-col gap-6 lg:flex-row lg:gap-10">
        <div className="flex-1 min-w-0">
          <div className="border border-border bg-card p-6 mb-4">
            <div className="flex flex-wrap items-center gap-2 mb-3">
              ...
              <span className={`inline-flex items-center rounded px-2 py-0.5 text-xs font-semibold uppercase tracking-wide ${EVENT_STATUS_COLORS[event.status] ?? FALLBACK_BADGE}`}>
                {event.status}
              </span>
            </div>
          ...
          <div className="border border-border bg-card p-6">
            <p className="label-military text-primary mb-4">
              Confirmed Operators ({event.participants.length})
            </p>
            <div className="flex flex-col gap-2">
              {event.participants.map((participant) => (
                ...
                >
                   <UserAvatar name={participant.name} username={participant.username} size="xs" linkToProfile />
        ...
        <aside className="w-full lg:w-72 shrink-0 flex flex-col gap-3">
          <div className="border border-border bg-card p-4">
            ...
            <button className="w-full rounded bg-primary px-3 py-2.5 text-xs font-semibold uppercase tracking-widest text-primary-foreground transition-colors hover:bg-primary/85 glow-red">
              RSVP — I&apos;m in
            </button>
          ...
          <div className="border border-border bg-card p-4">
            ...
            >
              <UserAvatar name={event.organizer.name} username={event.organizer.username} size="sm" linkToProfile />
              <div>
